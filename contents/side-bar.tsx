...
const SideBar = () => {
  ...
  return showSideBar ? (
    <section
      ref={sideBarRef}
      className="w-[300px] h-screen fixed right-0 bg-black/70 backdrop-blur-md drop-shadow-md shadow-xl rounded-lg border-white m-auto border-[1.5px] border-white/[0.13]">
